...
[![Build Status](https://builds.gbif.org/job/hp-gbif-be/badge/icon)](https://builds.gbif.org/job/hp-gbif-be/lastBuild/console)
...
# GBIF Hosted Portal: gbif-be

This Jekyll website, **[gbif-be (Staging)](https://gbif-be.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
