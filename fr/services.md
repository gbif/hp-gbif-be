...
- [GeoPick](https://geopick.gbif.org/) est un outil en ligne **open source** dérivé des [Georeferencing Best Practices (Chapman A.D. and Wieczorek J.R.)](https://docs.gbif.org/georeferencing-best-practices/1.0/en/) qui en suit les recommendations et pratiques.
